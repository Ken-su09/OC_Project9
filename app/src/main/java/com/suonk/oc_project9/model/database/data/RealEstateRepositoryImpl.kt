...
class RealEstateRepositoryImpl @Inject constructor(private val dao: RealEstateDao) :
    ...
    override fun getAllRealEstatesWithPhotos(): Flow<List<RealEstateEntityWithPhotos>> = dao.getAllRealEstatesWithPhotos()

    override fun getRealEstateById(id: Long): Flow<RealEstateEntityWithPhotos> = dao.getRealEstateById(id)
